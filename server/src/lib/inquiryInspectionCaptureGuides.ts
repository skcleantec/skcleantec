...
const HINTS: Readonly<Record<string, string>> = {
  entrance_overall: '현관 전체(문·바닥·벽)가 한눈에 보이게 촬영해 주세요.',
  living_overall: '거실 전체가 보이도록 넓게 촬영해 주세요.',
  kitchen_overall: '주방 전체(싱크·가스·장)가 보이게 촬영해 주세요.',
  room_overall: '방 전체(바닥·벽·천장)가 보이게 촬영해 주세요.',
  bathroom_overall: '욕실 전체가 보이도록 촬영해 주세요.',
  utility_overall: '다용도실 전체가 보이도록 촬영해 주세요.',
