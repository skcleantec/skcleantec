/**
 * 업종별 고객 안내 기본 문구. @see shared/orderFormIndustryGuideDefaults.ts
 * 위약 % 숫자는 넣지 않는다 — {{cancellationPolicy}} 가 브랜드 설정을 따른다.
 */
import { GUIDE_PLACEHOLDER_CANCELLATION_POLICY } from './orderFormGuidePlaceholders.js';
...
const PACK_IDS: OrderFormIndustryPackId[] = [
  'move_in',
  'aircon',
  'appliance',
  'grout',
...
function isOrderFormIndustryPackId(id: string): id is OrderFormIndustryPackId {
