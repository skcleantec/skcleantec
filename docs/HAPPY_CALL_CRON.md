...
**청소일(예약일) 전날 18:00(KST)~마감(전날 말일)** 해피콜이 **미완**이면 **1시간마다** 팀장에게 FCM 푸시를 보냅니다.  
**마감 이후에 생긴 접수**(당일 예약 등)는 전날 창이 없으므로 **푸시하지 않습니다.** 목록·배너는 미완으로 남을 수 있습니다.  
마감 이후 반복은 알림 설정의 「마감 초과 후 반복 알림」·접수당 최대 횟수를 따릅니다.  
