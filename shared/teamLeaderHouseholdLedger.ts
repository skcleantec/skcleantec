...
export type TeamLeaderHouseholdLedgerDirection = 'INCOME' | 'EXPENSE';
...
export type TeamLeaderHouseholdIncomeCategory =
  (typeof TEAM_LEADER_HOUSEHOLD_INCOME_CATEGORIES)[number];
export type TeamLeaderHouseholdExpenseCategory =
  (typeof TEAM_LEADER_HOUSEHOLD_EXPENSE_CATEGORIES)[number];
