...
class TelecrmRealtimeService : Service() {
    ...
    override fun onCreate() {
        ...
        IncomingCallMonitor.restart(this)
    ...
    companion object {
        private val ACTION_START = "${BuildConfig.APPLICATION_ID}.action.START_REALTIME"
        private val ACTION_STOP = "${BuildConfig.APPLICATION_ID}.action.STOP_REALTIME"
