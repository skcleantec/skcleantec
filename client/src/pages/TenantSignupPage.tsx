          ...
          {step === 'form' ? (
            ...
            >
              ...
              <label className="flex items-start gap-2 rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-2.5">
                ...
                <span className="text-fluid-2xs leading-relaxed text-slate-700">
                  <strong className="font-semibold">회원사 이용약관</strong> 및 개인정보 처리에 동의합니다.
                </span>
              </label>
            ...
            >
              <p className="rounded-lg border border-sky-100 bg-sky-50 px-3 py-2 text-fluid-2xs text-sky-900">
                <strong>{contactEmail}</strong> 로 인증번호를 보냈습니다. 10분 이내에 입력해 주세요.
              </p>
              {info ? <p className="text-fluid-2xs text-emerald-700">{info}</p> : null}
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="rounded-lg border border-slate-200 px-3 py-2 text-fluid-2xs font-semibold text-slate-700"
                >
                  인증번호 재발송
                </button>
                <button
