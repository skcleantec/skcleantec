...
export const crewMessages = {
  ...
  'crew.home.statsFootnote': {
    ko: '선택한 월급일 그룹 기준으로, 해당 월급일부터 다음 월급일 전날까지 예약일 접수만 집계합니다. 취소·보류는 제외하고 현장 인원 메모에 이름이 적힌 건만 세며 현장 일정 화면과 같습니다.',
    th: 'ตามกลุ่มวันจ่ายที่เลือก นับงานตามวันนัดในช่วงวันจ่ายถึงวันก่อนจ่ายครั้งถัดไป ไม่นับยกเลิก/พัก และนับเฉพาะที่ระบุชื่อในโน้ตพนักงาน',
  },
