...
export const crewMessages = {
  ...
  'crew.home.statsFootnote': {
    ko: '선택한 월급일 그룹·그룹 「급여·실적 집계」 설정에 따라 근무일 또는 접수 건으로 셉니다. 취소·보류는 제외하고 현장 인원 메모에 이름이 적힌 접수만 반영합니다.',
    th: 'นับตามการตั้งค่ากลุ่ม (วันทำงานหรืองาน) ไม่นับยกเลิก/พัก และเฉพาะชื่อในโน้ตพนักงาน',
  },
  'crew.home.statsNoPayDay': {
    ko: '이 그룹 멤버에 급여일(월급일)이 설정된 사람이 없습니다. 관리자 팀원 설정에서 월급일을 입력해 주세요.',
    th: 'ไม่มีสมาชิกที่ตั้งวันจ่ายเงินเดือน กรุณาตั้งค่าที่หน้าทีม',
  },
  'crew.home.payDayGroupLabel': {
    ko: '월급일 {day}일',
    th: 'จ่ายวันที่ {day}',
  },
  'crew.home.statsPeriodRange': {
    ko: '{start} ~ {end}',
    th: '{start} ~ {end}',
  },
  'crew.home.statsMemberPeriod': {
    ko: '({start} ~ {end})',
    th: '({start} ~ {end})',
  },
  ...
  'crew.home.statsUnitInquiry': {
    ko: '건',
    th: 'งาน',
  },
  'crew.home.statsUnitDay': {
    ko: '일',
    th: 'วัน',
  },
  /** @deprecated crew.home.statsUnitDay / statsUnitInquiry 사용 */
  'crew.home.statsUnit': {
    ko: '건',
    th: 'งาน',
  },

  /** CrewSettingsPage — 그룹장만 표시명(태국어·몽골어 등) */
  'crew.settings.title': {
    ko: '멤버 표시 이름',
    th: 'ชื่อแสดงสมาชิก',
  },
  'crew.settings.titleContact': {
    ko: '멤버 연락처·주소',
    th: 'ติดต่อและที่อยู่สมาชิก',
  },
  'crew.settings.intro': {
    ko: '한글 이름 아래에 보조 이름(태국어·몽골어 등)을 넣으면 홈·일정·명단에서 팀원이 본인을 찾기 쉽습니다. 각 팀원 행의 「저장」만 해당 사람 표시명을 반영합니다.',
    th: 'ใส่ชื่อรองใต้ชื่อเกาหลีเพื่อให้หาตัวเองง่าย กด「บันทึก」ในแถวนั้นเพื่อบันทึกเฉพาะคนนั้น',
  },
  'crew.settings.introContact': {
    ko: '각 팀원의 연락처·집 주소를 수정할 수 있습니다. 이름은 관리자가 등록한 한글 이름을 그대로 사용합니다.',
    th: 'แก้เบอร์โทรและที่อยู่ได้ ชื่อใช้ตามที่ผู้ดูแลลงทะเบียน',
  },
