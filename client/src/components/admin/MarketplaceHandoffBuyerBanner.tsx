...
export function MarketplaceHandoffBuyerBanner({
  ...
  if (compact) {
    return (
      ...
      >
        <span className="font-semibold">정보공유 인수</span>
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="text-fluid-2xs text-violet-800">공유 업체</span>
      </div>
      ...
      <p className="mt-1 text-fluid-2xs leading-snug text-violet-900/85">
        위 업체에서 정보공유로 인수한 접수입니다. 수수료는 정산·결제 금액 내역에 반영됩니다.
      </p>
    </div>
  );
}
