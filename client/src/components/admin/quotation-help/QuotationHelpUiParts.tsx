  ...
  return (
    <HelpUiShell>
      <label className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-1.5 text-[11px] text-slate-600 shadow-sm">
        ...
        <select
          className="min-w-[100px] rounded-md border border-slate-200 bg-white px-2 py-1 text-[12px] text-slate-800"
          value={value}
          disabled
          aria-hidden
          tabIndex={-1}
  ...
  return (
    <HelpUiShell>
      <label className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-1.5 text-[11px] text-slate-600 shadow-sm">
        ...
        <select
          className="min-w-[140px] rounded-md border border-slate-200 bg-white px-2 py-1 text-[12px] text-slate-800"
          disabled
          aria-hidden
          tabIndex={-1}
        >
  ...
  return (
    <HelpUiShell block>
      <div className="w-full max-w-[12rem]">
        <span className="block text-[10px] font-medium text-slate-600 mb-0.5">{label}</span>
        <span className="block border-b border-dashed border-slate-300 text-[11px] text-slate-400 py-0.5">
          입력…
        </span>
      </div>
    </HelpUiShell>
