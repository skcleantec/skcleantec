...
export const INQUIRY_WORKFLOW_STEPS: readonly WorkflowGuideStep[] = [
  ...
  },
  {
    ...
    tip: '「발급 및 링크 생성」으로 링크를 만든 뒤, 「알림톡 발송」또는 「메시지 복사」·「링크 복사」로 보냅니다. 「대기 접수 연결」을 하면 접수목록·스케줄이 한 줄로 이어집니다.',
    ...
    sections: [
      {
        ...
        span: 'full',
        items: [
          '「발주서 양식」을 고르고, 있으면 「대기 접수 연결」로 접수목록의 대기·미제출 건을 잇습니다. 연결 없이 내면 발주서 목록에만 남을 수 있습니다.',
          '상담에서 아는 칸만 채운 뒤 아래 「발급 및 링크 생성」을 누릅니다. 고객용 링크가 만들어지고 아래에 초록 「발급 완료」칸이 열립니다.',
          '알림톡으로 보내기: 고객 연락처가 있고 알림톡이 켜져 있으면 노란 「알림톡 발송」을 누릅니다. 「알림톡 발송 중…」이 지나고 「알림톡을 발송했습니다.」가 나오면 고객 카카오에 링크 안내가 갑니다. 버튼이 없으면 알림톡 메뉴가 꺼진 것이니, 아래 복사 방법으로 보냅니다.',
          '복사해서 보내기: 「메시지 복사」는 「고객 발송 메시지」칸의 안내 문구와 링크 전부입니다. 카카오톡이나 문자 창을 연 뒤 붙여 넣기 하면 됩니다.',
          '주소만 보내려면 「링크 복사」만 눌러 붙여 넣습니다. 「새 창」은 우리가 고객 화면을 미리 보는 용도입니다.',
          '같은 건을 다시 보내려면 옆 「링크 보내기」·발주서 목록에서 「메시지 복사」·「링크 복사」또는 「발주서 알림톡 발송」을 씁니다.',
        ],
      },
      {
        title: '아이콘',
      ...
      },
      {
        title: '색',
        items: [
          '「발급 완료」칸은 연한 초록 테두리입니다.',
          '「알림톡 발송」은 노란 버튼입니다.',
          '잠긴 칸은 상담사가 이미 채운 값입니다. 고객 화면에서는 고칠 수 없습니다.',
        ],
      },
      {
        title: '설정',
        items: [
          '복사 문구는 「고객링크설정」에서 바꿉니다.',
          '알림톡 켜짐·잔액은 「알림톡」메뉴입니다.',
  ...
  },
  {
    ...
    tip: '목록에서 「메시지 복사」·「링크 복사」또는 「발주서 알림톡 발송」으로 다시 보냅니다. 고객이 제출해야 예약완료입니다.',
    ...
    sections: [
      {
        ...
        span: 'full',
        items: [
          '발주서 목록에서 해당 줄을 눌러 관리 창을 엽니다.',
          '알림톡으로 보내기: 연락처가 있으면 「발주서 알림톡 발송」을 누릅니다. 연락처가 없으면 「고객 연락처가 없어 발송할 수 없습니다」입니다.',
          '복사해서 보내기: 「고객 발송용 메시지」또는 「발주서 링크」를 누른 뒤 카카오톡·문자에 붙여 넣습니다. 발급 직후 「발급 완료」칸의 「메시지 복사」·「링크 복사」와 같습니다.',
          '고객이 폼을 끝내야 접수 상태가 예약완료로 바뀝니다. 새 링크가 필요하면 발주서 발급에서 「발급 및 링크 생성」을 다시 합니다.',
        ],
      },
      {
        title: '아이콘',
