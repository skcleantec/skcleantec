...
function ListPaginationSummary({
  ...
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-fluid-xs text-gray-600">
      <span>
      ...
      <label className="inline-flex items-center gap-1.5">
        ...
        <select
          ...
          className="rounded border border-gray-300 bg-white px-2 py-1 text-fluid-xs text-gray-900 focus:border-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400"
