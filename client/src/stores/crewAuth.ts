const TOKEN_KEY = 'sk_crew_token';
const AUTH_CHANGE_EVENT = 'sk_crew_auth';
...
export function subscribeCrewAuth(onStoreChange: () => void) {
...
export function setCrewToken(token: string) {
  try {
...
export function clearCrewToken() {
  try {
