...
WORKDIR /app/client
ARG VITE_TENANT_HOST_BASE_DOMAIN=""
ARG VITE_TENANT_HOST_ALIAS_DOMAINS=""
ARG VITE_PLATFORM_HOST_SUBDOMAIN="platform"
ENV VITE_TENANT_HOST_BASE_DOMAIN=$VITE_TENANT_HOST_BASE_DOMAIN
ENV VITE_TENANT_HOST_ALIAS_DOMAINS=$VITE_TENANT_HOST_ALIAS_DOMAINS
ENV VITE_PLATFORM_HOST_SUBDOMAIN=$VITE_PLATFORM_HOST_SUBDOMAIN
...
RUN apt-get update -y \
  && apt-get install -y --no-install-recommends ca-certificates curl gnupg openssl fonts-nanum \
