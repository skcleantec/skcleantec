...
| 영역 | 내용 |
|------|------|
| **왼쪽 (넓게)** | 텔레CRM 팝업 — 접수·스크립트·가격 |
| **오른쪽 (좁게, 약 420~480px)** | Google Chrome — 숨고 (모바일 레이아웃) |

### 체크리스트 (정상)

- [ ] Chrome **안**에 숨고 **채팅 목록**이 온전히 보임 (옆으로 밀려 잘리지 않음)
- [ ] Chrome **하단**에 검은·회색 **빈 여백 없음**
- [ ] 채팅방 **하단 입력·전송** 줄 보임
- [ ] CRM **「숨고 메시지」** — **「직접 보내기」**·**「메시지 보내기」**가 프리셋 스크롤과 관계없이 **항상** 보임
...
마케터 설명서: `agent/product/HELP_GUIDE_MARKETER.md` §14 · 개발 룰: `.cursor/rules/telecrm-soomgo-chat-ui.mdc`
