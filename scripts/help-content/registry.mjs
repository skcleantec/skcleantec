...
import {
  ...
  buildHouseholdLedgerMarkdown,
  buildNotificationPolicyMarkdown,
  buildAlimtalkSettingsMarkdown,
  buildTeamLeaderTrainingMarkdown,
  buildInquiryTrashMarkdown,
  buildChangeHistoryMarkdown,
  buildInquiryDeleteMarkdown,
...
const DETAILED_BY_PATH = {
  ...
  '/admin/team-leaders/household-ledger': buildHouseholdLedgerMarkdown,
  '/admin/team-leaders/notification-policy': buildNotificationPolicyMarkdown,
  '/admin/team-leaders/alimtalk': buildAlimtalkSettingsMarkdown,
  '/admin/team-leaders/team-leader-training': buildTeamLeaderTrainingMarkdown,
  '/admin/team-leaders/inquiry-trash': buildInquiryTrashMarkdown,
  '/admin/team-leaders/change-history': buildChangeHistoryMarkdown,
  '/admin/team-leaders/inquiry-delete': buildInquiryDeleteMarkdown,
