...
const ADMIN_PAGES = [
  ...
  },
  {
    ...
    screenshotFile: '',
    hint: '하루·한 달 접수를 한꺼번에 휴지통으로 보냅니다.',
  },
  {
    module: '광고비',
    moduleOrder: 6,
